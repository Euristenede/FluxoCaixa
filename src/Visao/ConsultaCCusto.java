 ...
 * @author euris
 */
public class ConsultaCCusto extends javax.swing.JDialog {
    ConectaBanco conexao = new ConectaBanco();
    
    String SQL_consultaGeneria = "SELECT CD_CCUSTO, DS_CCUSTO FROM CENTROCUSTO";
     ...
     */
    public ConsultaCCusto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        conexao.conecta();
        initComponents();
    ...
    public void preencherTabela(String SQL){
        ...
        try {
            conexao.rs.first();
            do{
                dados.add(new Object[]{conexao.rs.getString("CD_CCUSTO"),
                                       conexao.rs.getString("DS_CCUSTO")});
            }while(conexao.rs.next());
            
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Erro ao preencher o ArrayList da consulta do Centro de Custo. \nErro: "+ ex);
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta Centros de Custos");
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        String SQL_consulta = "SELECT CD_CCUSTO, DS_CCUSTO FROM CENTROCUSTO WHERE DS_CCUSTO LIKE '%"+jTextFieldConsulta.getText()+"%';";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaCCusto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultaCCusto dialog = new ConsultaCCusto(new javax.swing.JFrame(), true);
