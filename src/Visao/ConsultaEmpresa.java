...
public class ConsultaEmpresa extends javax.swing.JDialog {
    ...
    String SQL_consultaGeneria = "SELECT CD_EMPRESA, NM_EMPRESA FROM EMPRESA";
    ...
    public void preencherTabela(String SQL){
        ...
        try {
            conexao.rs.first();
            do{
                dados.add(new Object[]{conexao.rs.getString("CD_EMPRESA"),
                                       conexao.rs.getString("NM_EMPRESA")});
            }while(conexao.rs.next());
            
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Erro ao preencher o ArrayList da consulta da Empresa. \nErro: "+ ex);
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta Empresa");
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        String SQL_consulta = "SELECT CD_EMPRESA, NM_EMPRESA FROM EMPRESA WHERE NM_EMPRESA LIKE '%"+jTextFieldConsulta.getText()+"%';";
