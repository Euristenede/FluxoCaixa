 ...
 * @author euris
 */
public class ConsultaDespCCusto extends javax.swing.JDialog {
    ConectaBanco conexao = new ConectaBanco();
    int codigoCCusto;
    String SQL_consultaGeneria;
     ...
     */
    public ConsultaDespCCusto(java.awt.Frame parent, boolean modal, String consulta) {
        super(parent, modal);
        this.SQL_consultaGeneria = consulta;
        conexao.conecta();
        initComponents();
    ...
    private ConsultaDespCCusto(JFrame jFrame, boolean b) {
    ...
    public void preencherTabela(String SQL){
        ...
        try {
            conexao.rs.first();
            do{
                dados.add(new Object[]{conexao.rs.getString("CD_DESPCCUSTO"),
                                       conexao.rs.getString("DS_DESPCCUSTO")});
            }while(conexao.rs.next());
            
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Erro ao preencher o ArrayList da consulta das Despesas por Centro de Custo. \nErro: "+ ex);
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta Despesa por Centro de Custo");
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        String SQL_consulta = "SELECT CD_DESPCCUSTO, DS_DESPCCUSTO FROM DESPESACCUSTO WHERE DS_DESPCCUSTO LIKE '%"+jTextFieldConsulta.getText()+"%';";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaDespCCusto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultaDespCCusto dialog = new ConsultaDespCCusto(new javax.swing.JFrame(), true);
