...
public class ConsultaBanco extends javax.swing.JDialog {
    ...
    String SQL_consultaGeneria = "SELECT CD_BANCO, DS_BANCO FROM BANCO";
     ...
     */
    public ConsultaBanco(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        conexao.conecta();
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta Banco");
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        String SQL_consulta = "SELECT CD_BANCO, DS_BANCO FROM BANCO WHERE DS_BANCO LIKE '%"+jTextFieldConsulta.getText()+"%';";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultaBanco dialog = new ConsultaBanco(new javax.swing.JFrame(), true);
